...
public interface implListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link implParser#lhs}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the {@code Lefthandside}
	 * labeled alternative in {@link implParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterLefthandside(implParser.LefthandsideContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Lefthandside}
	 * labeled alternative in {@link implParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitLefthandside(implParser.LefthandsideContext ctx);
	/**
